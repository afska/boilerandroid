package io.j3solutions.boilerandroid.utils.preferences
...
object PreferencesManager {
    ...
    private val preferences: SharedPreferences by lazy { getSharedPreferences(RootApplication.appContext) }
...
class DelegatedPreference<out T>(private val default: T, private var prefix: String = "") {
    ...
    class TypeNotImplementedException(propName: String) :
        Exception("Type of $propName is not implemented on DelegatedPreference and thus invalid")
}
